...
export default function DevelopmentProgressDetail({ className }: DevelopmentProgressDetailProps) {
  ...
  return (
    <div className={className} id="development">
      ...
      <Timeline size="lg" className="space-y-8">
        <TimelineItem 
          label="2016 - 2020"
          color="blue"
          status="finish"
          dot={<span className="text-white text-lg font-bold">1</span>}
        >
        ...
        <TimelineItem 
          ...
          color="green"
          status="finish"
          dot={<span className="text-white text-lg font-bold">2</span>}
        >
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-2xl font-semibold text-gray-900">
              {t('phase2Title')}
        ...
        <TimelineItem 
          ...
          color="purple"
          status="process"
          dot={<span className="text-white text-lg font-bold">3</span>}
        >
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-2xl font-semibold text-gray-900">
              {t('phase3Title')}
