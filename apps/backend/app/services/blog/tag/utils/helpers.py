...
def build_blog_tag_payloads(db: Session, tags: list[BlogTag]) -> list[dict[str, object]]:
...
def build_blog_tag_payloads_for_keys(db: Session, keys: list[str]) -> list[dict[str, object]]:
